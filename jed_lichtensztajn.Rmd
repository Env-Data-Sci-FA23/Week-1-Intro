...
```{r}
kenya_climate<-read.csv("data/kenya_county_climates.csv")
```
...
```{r}
meanprecipitation= mean(kenya_climate)
  
```

```{r}
kenya_climate %>%
select(Precipitation_585_30,Precipitation_585_90,Precipitation_hist,Precipitation_585_50,Precipitation_585_70,County) 
```

```{r}
kenya_climate %>%
precip_county<- select(Precipitation_585_30,Precipitation_585_90,Precipitation_hist,Precipitation_585_50,Precipitation_585_70,County) 
```
...
```{r}
mean(kenya_climate, precipitation)
```
