...
```{r}
kenyacc <- read_csv("C:/Users/molli/OneDrive/Desktop/intro_R/ESS-523A/week1/Week-1-Intro/data/kenya_county_climates.csv")
```
...
kenya_precip <- kenyacc %>%
  select(Precipitation_585_30, Precipitation_585_50, Precipitation_585_70, Precipitation_585_90, Precipitation_hist, County) %>%
  filter(Precipitation_585_90 > mean(c(Precipitation_585_30, Precipitation_585_50, Precipitation_585_70, Precipitation_585_90)), na.rm = TRUE) %>%
  pivot_longer(cols = c(Precipitation_585_30, Precipitation_585_50, Precipitation_585_70, Precipitation_585_90), names_to = "precip", values_to = "precip_value")

```

Question: How many counties have predicted precip val?ues greater than the total average for all counties?
...
n_distinct(kenya_precip$County)

ggplot(kenya_precip, aes(x = precip, y = precip_value))+
  geom_col() +
  facet_wrap(~County)
