...
```{r}
data <- file.choose('kenya_county_climates.csv')
kenya_county_climates <- read.csv(data)
```
...
```{r}
 df<- select(kenya_county_climates, contains("Precipitation"), "County") %>%
