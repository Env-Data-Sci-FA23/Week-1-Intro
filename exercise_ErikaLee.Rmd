...
kenya_data_selected <- kenya_data %>%
  select(-c(Min_Temp_585_30, Min_Temp_585_50, Min_Temp_585_70, Min_Temp_585_90, Min_Temp_hist, Max_Temp_585_30, Max_Temp_585_50, Max_Temp_585_70, Max_Temp_585_90, Max_Temp_hist, Precipitation_hist)) %>%
  filter(Precipitation_585_90 > mean(c(Precipitation_585_30, Precipitation_585_50, Precipitation_585_70, Precipitation_585_90), na.rm = FALSE)) %>%
...
```{r}
ggplot(data = kenya_data_selected) + 
