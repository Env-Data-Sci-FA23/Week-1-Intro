...
```{r}
kenya <- read_csv("/Users/lauryn/Desktop/Enviro_Data_Sci_FA23/Week-1-Intro/data/kenya_county_climates.csv")
```
...
```{r}
k_long <- pivot_longer(k_clean2, contains("Precipitation"))
```
...
k_long %>% 
  ...
  facet_wrap("County") +
  labs(xlab = "Precipitation Year", title = "Kenya Precipitation by County" ) +
  theme_bw()
